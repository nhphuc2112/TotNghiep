			...
			<div class="form-group">
				<div class="input-group">
					<?php if ( cena_tbay_get_config('search_type') != 'all' && cena_tbay_get_config('search_category') ): ?>
				  	...
				  	<?php endif; ?>
				  		<input type="text" placeholder="<?php esc_attr_e( 'Enter your search ...', 'cena' ); ?>" name="s" class="tbay-search form-control input-sm"/>
						<div class="button-group input-group-addon">
							<button type="submit" class="button-search btn btn-sm"><?php esc_html_e( 'Search', 'cena' ); ?> <i class="zmdi zmdi-search"></i></button>
						</div>
