		...
		<?php foreach ($posts as $key => $post) { ?>
			...
			<article>
				...
				<div class="post-rate ratings">
					<ul class="rated" style="width:<?php print trim($max_rating * 16); ?>px" title="<?php echo esc_attr($current_rating); ?>">
						<li class="rating" style="width:<?php print trim($rating * 16); ?>px">
							<span class="average">
								<?php print trim($current_rating); ?>
							</span>
							<span class="best">
								<?php print trim($max_rating); ?>
							</span>
						</li>
					</ul>
				</div>
