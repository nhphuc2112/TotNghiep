...
class Tbay_Widget_Recent_Post extends Tbay_Widget {
    public function __construct() {
        parent::__construct(
            'tbay_recent_post',
            esc_html__('Tbay Recent Posts Widget', 'cena'),
            array( 'description' => esc_html__( 'Show list of recent post', 'cena' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'number_post' )); ?>"><?php esc_html_e( 'Num Posts:', 'cena' ); ?></label>
