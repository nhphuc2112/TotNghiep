...
class Tbay_Widget_Single_Image extends Tbay_Widget {
    public function __construct() {
        parent::__construct(
            'tbay_single_image',
            esc_html__('Tbay Single Image Widget', 'cena'),
            array( 'description' => esc_html__( 'Show single image', 'cena' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'description' )); ?>"><?php esc_html_e( 'Description:', 'cena' ); ?></label>
        ...
        <label for="<?php echo esc_attr($this->get_field_id( 'single_image' )); ?>"><?php esc_html_e( 'Image:', 'cena' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'alt' )); ?>"><?php esc_html_e( 'Alt:', 'cena' ); ?></label>
