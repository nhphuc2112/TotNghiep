...
class Tbay_Widget_Recent_Comment extends Tbay_Widget {
    public function __construct() {
        parent::__construct(
            'tbay_recent_comment',
            esc_html__('Tbay Recent Comments Widget', 'cena'),
            array( 'description' => esc_html__( 'Show list of recent comments', 'cena' ), )
        );
    ...
    public function form( $instance ) {
        if ( isset( $instance[ 'title' ] ) ) {
            ...
            $title = esc_html__( 'Latest Post', 'cena' );
        }
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'number_comment' )); ?>"><?php esc_html_e( 'Num Comments:', 'cena' ); ?></label>
