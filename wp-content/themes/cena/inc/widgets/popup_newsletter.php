...
class Tbay_Widget_Popup_Newsletter extends Tbay_Widget {
    public function __construct() {
        parent::__construct(
            ...
            esc_html__('Tbay Popup Newsletter Widget', 'cena'),
            array( 'description' => esc_html__( 'Show Popup Newsletter', 'cena' ), )
        );
    ...
    public function form( $instance ) {
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><strong><?php esc_html_e('Title:', 'cena');?></strong></label>
        ...
        <label for="<?php echo esc_attr($this->get_field_id( 'image' )); ?>"><?php esc_html_e( 'Image:', 'cena' ); ?></label>
