	...
	<form id="add_payment_method" method="post">
		<div id="payment" class="widget">
			...
			<div class="form-group">
				...
				<input type="submit" class="button alt<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" id="place_order" value="<?php esc_attr_e( 'Add Payment Method', 'cena' ); ?>" />
...
<?php else : ?>
	<?php wc_print_notice( esc_html__( 'New payment methods can only be added during checkout. Please contact us if you require assistance.', 'cena' ), 'notice' ); ?>
<?php endif; ?>