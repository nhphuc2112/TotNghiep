...
$label = !empty($args['product_name']) ? sprintf(esc_html__('%s quantity', 'cena'), wp_strip_all_tags($args['product_name'])) : esc_html__('Quantity', 'cena');
...
<div class="quantity <?php echo esc_attr($type); ?>">
    ...
    ?>
		...
		<input 
			...
			aria-label="<?php esc_attr_e( 'Product quantity', 'cena' ); ?>"
