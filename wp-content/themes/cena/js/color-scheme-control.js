...
( function( api ) {
	var cssTemplate = wp.template( 'cena-color-scheme' ),
		colorSchemeKeys = [
			'background_color',
	...
	function updateCSS() {
		...
		colors.border_cena_color = Color( colors.textcolor ).toCSS( 'rgba', 0.3 );
		...
		colors.sidebar_border_cena_color = Color( colors.sidebar_textcolor ).toCSS( 'rgba', 0.3 );
