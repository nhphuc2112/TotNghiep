...
<form id="affwp-register-form-<?php echo esc_attr( $form_id_suffix ); ?>" class="affwp-form affwp-register-form" action="" method="post">
	...
	<fieldset>
		<legend><?php _e( 'Đăng ký tài khoản affliate mới', 'affiliate-wp' ); ?></legend>
		...
		<p>
			<label for="affwp-user-name"><?php _e( 'Tên của bạn', 'affiliate-wp' ); ?></label>
			<input id="affwp-user-name" type="text" name="affwp_user_name" value="<?php echo ! empty( $user_name ) ? esc_attr( $user_name ) : ''; ?>" title="<?php esc_attr_e( 'Nhập tên của bạn', 'affiliate-wp' ); ?>" <?php echo affwp_required_field_attr( 'your_name' ); ?> />
		</p>
		...
		<p>
			<label for="affwp-user-email"><?php _e( 'Tài khoản email', 'affiliate-wp' ); ?></label>
		...
		<p>
			<label for="affwp-payment-email"><?php _e( 'Email thanh toán', 'affiliate-wp' ); ?></label>
		...
		<p>
			<label for="affwp-promotion-method"><?php _e( 'Bạn sẽ làm gì để quảng bá sản phẩm của chúng tôi?', 'affiliate-wp' ); ?></label>
		...
		<?php if ( ! is_user_logged_in() && isset( $required_registration_fields['password'] ) ) : ?>
			...
			<p>
				<label for="affwp-user-pass"><?php _e( 'Mật khẩu', 'affiliate-wp' ); ?></label>
				<input id="affwp-user-pass" required="required" class="password" type="password" name="affwp_user_pass" />
			</p>

			<p>
				<label for="affwp-user-pass2"><?php _e( 'Nhập lại mật khẩu', 'affiliate-wp' ); ?></label>
