												...
												<p style="text-align: center; margin-top: 20px; font-size: 15px; color: #a09e9e">
													<small>
														<?php echo wp_kses_post( sprintf(
															...
															__( 'Đây là email được gửi từ <a href="%1$s" style="color: #a09e9e;">%2$s</a>.<br><a href="%3$s" style="color: #a09e9e;">Nhấn vào đây</a> để tắt tính năng gửi email tự động.', 'affiliate-wp' ),
															esc_url( home_url() ),
															get_bloginfo( 'name' ),
															/**
