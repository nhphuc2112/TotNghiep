...
<div id="affwp-affiliate-dashboard-referral-counts" class="affwp-tab-content">
	...
	<table class="affwp-table affwp-table-responsive">
		<thead>
			<tr>
				<th><?php _e( 'Doanh thu chưa thanh toán', 'affiliate-wp' ); ?></th>
				<th><?php _e( 'Doanh thu đã thanh toán', 'affiliate-wp' ); ?></th>
				<th><?php _e( 'Lượt ghé', 'affiliate-wp' ); ?></th>
				<th><?php _e( 'Lượt ghé', 'affiliate-wp' ); ?></th>
			</tr>
		</thead>
		...
		<tbody>
			<tr>
				<td data-th="<?php _e( 'Doanh thu chưa thanh toán', 'affiliate-wp' ); ?>"><?php echo affwp_count_referrals( $affiliate_id, 'unpaid' ); ?></td>
				<td data-th="<?php _e( 'Doanh thu đã thanh toán', 'affiliate-wp' ); ?>"><?php echo affwp_count_referrals( $affiliate_id, 'paid' ); ?></td>
				<td data-th="<?php _e( 'Lượt ghé', 'affiliate-wp' ); ?>"><?php echo affwp_count_visits( $affiliate_id ); ?></td>
				<td data-th="<?php _e( 'Lượt ghé', 'affiliate-wp' ); ?>"><?php echo affwp_get_affiliate_conversion_rate( $affiliate_id ); ?></td>
			</tr>
		</tbody>
	</table>
