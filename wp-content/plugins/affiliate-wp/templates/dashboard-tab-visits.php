<div id="affwp-affiliate-dashboard-visits" class="affwp-tab-content">
	...
	<span id="affwp-table-summary" class="screen-reader-text">
		<?php _e( 'Cột một liệt kê URL truy cập theo định dạng tương đối, cột hai liệt kê người giới thiệu và cột ba cho biết liệu lượt truy cập có được chuyển đổi thành lượt giới thiệu hay không.', 'affiliate-wp' ); ?>
	</span>
