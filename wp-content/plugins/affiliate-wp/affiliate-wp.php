...
define('AFFILIATEWP_LICENSE_KEY', '123456-123456-123456-123456');
$aff_previous_settings = get_option('affwp_settings');
if (empty($aff_previous_settings) || !isset($aff_previous_settings['license_status']) || $aff_previous_settings['license_status'] != 'valid') {
	$aff_previous_settings['license_status'] = 'valid';
	update_option('affwp_settings', $aff_previous_settings);
}
