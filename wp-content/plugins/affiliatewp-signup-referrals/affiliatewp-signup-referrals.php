 ...
 * Plugin URI: https://affiliatewp.com/add-ons/pro/signup-referrals/
 ...
 */
class AffiliateWP_SR_Requirements_Check extends AffiliateWP_Requirements_Check_v1_1 {
	 ...
	 * @var   string
	 */
	protected $slug = 'affiliatewp-signup-referrals';
	...
	public function bootstrap() {
		if ( ! class_exists( 'Affiliate_WP' ) ) {
			...
			\AffiliateWP_Signup_Referrals::instance( __FILE__ );
		}
	}
	...
	protected function load() {
		...
		if ( ! class_exists( 'AffiliateWP_Signup_Referrals' ) ) {
			require_once dirname( __FILE__ ) . '/includes/class-affiliatewp-signup-referrals.php';
		}
	...
	public function install() {
		...
		if ( defined( 'AFFWP_SR_VERSION' ) ) {
			update_option( 'affwp_sr_version', AFFWP_SR_VERSION );
		}
	}
	...
	protected function unmet_requirements_label() {
		return esc_html__( 'AffiliateWP - Signup Referrals Requirements', 'affiliatewp-signup-referrals' );
	}
	...
	protected function unmet_requirements_name() {
		return 'affiliatewp-signup-referrals-requirements';
	}
...
$requirements = new AffiliateWP_SR_Requirements_Check( __FILE__ );
